...
ActiveRecord::Schema[8.0].define(version: 2026_09_06_000100) do
  ...
  create_table "master_endoscopy_dataset_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dataset_code", "detail_type", "code"], name: "index_endoscopy_dataset_details_on_dataset_type_code", unique: true
    t.index ["dataset_code"], name: "index_master_endoscopy_dataset_details_on_dataset_code"
  end

  create_table "master_endoscopy_datasets", force: :cascade do |t|
    t.string "dataset_code", null: false
    t.string "name", null: false
    t.string "name_kana"
    t.date "valid_from"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dataset_code"], name: "index_master_endoscopy_datasets_on_dataset_code", unique: true
  end

  create_table "master_endoscopy_exam_types", force: :cascade do |t|
    t.string "exam_type_code", null: false
    t.string "name", null: false
    t.string "short_name"
    t.string "name_kana"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["exam_type_code"], name: "index_master_endoscopy_exam_types_on_exam_type_code", unique: true
    t.index ["jed_exam_category"], name: "index_master_endoscopy_exam_types_on_jed_exam_category"
    t.index ["search_name"], name: "index_master_endoscopy_exam_types_on_search_name"
  end

  create_table "master_endoscopy_item_layout_cells", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_code"], name: "index_master_endoscopy_item_layout_cells_on_item_code"
    t.index ["layout_id", "grid_row", "grid_column"], name: "index_endoscopy_layout_cells_on_layout_and_position", unique: true
  end

  create_table "master_endoscopy_item_layouts", force: :cascade do |t|
    t.string "name", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_master_endoscopy_item_layouts_on_name", unique: true
  end

  create_table "master_endoscopy_items", force: :cascade do |t|
  ...
  create_table "master_patient_cautions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_master_patient_cautions_on_code", unique: true
  end
  ...
  create_table "master_physio_dataset_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dataset_code", "detail_type", "code"], name: "index_physio_dataset_details_on_dataset_type_code", unique: true
    t.index ["dataset_code"], name: "index_master_physio_dataset_details_on_dataset_code"
  end

  create_table "master_physio_datasets", force: :cascade do |t|
    t.string "dataset_code", null: false
    t.string "name", null: false
    t.string "name_kana"
    t.date "valid_from"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dataset_code"], name: "index_master_physio_datasets_on_dataset_code", unique: true
  end

  create_table "master_physio_exam_types", force: :cascade do |t|
    t.string "exam_type_code", null: false
    t.string "name", null: false
    t.string "short_name"
    t.string "name_kana"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["exam_type_code"], name: "index_master_physio_exam_types_on_exam_type_code", unique: true
    t.index ["search_name"], name: "index_master_physio_exam_types_on_search_name"
  end

  create_table "master_physio_item_layout_cells", force: :cascade do |t|
    t.integer "layout_id", null: false
    t.integer "grid_row", null: false
    t.integer "grid_column", null: false
    t.string "cell_type", default: "item", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_code"], name: "index_master_physio_item_layout_cells_on_item_code"
    t.index ["layout_id", "grid_row", "grid_column"], name: "index_physio_layout_cells_on_layout_and_position", unique: true
  end

  create_table "master_physio_item_layouts", force: :cascade do |t|
    t.string "name", null: false
    t.integer "row_count", default: 10, null: false
    t.integer "column_count", default: 5, null: false
    t.integer "display_order"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name"], name: "index_master_physio_item_layouts_on_name", unique: true
  end

  create_table "master_physio_items", force: :cascade do |t|
    t.string "item_code", null: false
    t.string "name", null: false
    t.string "short_name"
    t.string "name_kana"
    ...
    t.index ["item_code"], name: "index_master_physio_items_on_item_code", unique: true
    t.index ["kind"], name: "index_master_physio_items_on_kind"
  end

  create_table "master_physio_set_items", force: :cascade do |t|
    t.string "set_item_code", null: false
    t.string "member_item_code", null: false
    t.integer "display_order"
    t.text "note"
