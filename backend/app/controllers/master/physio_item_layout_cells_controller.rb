module Master
  # 生理検査オーダーレイアウトの1マス。レイアウト編集画面から操作する。
  class PhysioItemLayoutCellsController < BaseController
