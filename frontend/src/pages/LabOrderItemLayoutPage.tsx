...
function LayoutEditor({ layoutId, onDeleted }: { layoutId: number; onDeleted: () => void }) {
  ...
  return (
    <>
      <form className="lab-layout__bar" onSubmit={handleSaveLayout}>
        <label>
          名前
          <input
            type="text"
        ...
        <div className="lab-layout__bar-actions">
      ...
      <div className="lab-layout__grid-wrap">
        <table className="lab-layout__grid">
          <tbody>
            {rows.map((row) => (
              <tr key={row}>
                {columns.map((column) => {
                  ...
                  const classes = [
                    "lab-layout__cell",
                    cell?.cell_type === "label" ? "lab-layout__cell--label" : "",
...
function CellEditor({ layoutId, position, cell, mutations, onClose }: CellEditorProps) {
  ...
  return (
    <section className="lab-layout__editor">
      ...
      {cell ? (
        <form className="lab-layout__editor-row" onSubmit={handleSave}>
          <span className="lab-layout__editor-kind">
        ...
        <>
          <form className="lab-layout__editor-row" onSubmit={handlePlaceLabel}>
            <label>
              ラベルを配置
              <input
                type="text"
          ...
          <div className="lab-layout__editor-row">
            <label>
              検査項目を配置
              <input
                type="text"
