...
//
// 手術一覧とは別の画面(部門業務メニュー)にしている。一覧は「この日の手術を 1 件ずつ
// 処理する」画面で、進捗を進めながら縦に読む。カレンダーは「空いているところを探して
// 入れる」画面で、部屋 × 時刻の面を横に読む —— 使う場面も見る向きも違い、一覧の
// 絞り込み(手術室・病棟・診療科・ステータス)はカレンダーでは使わない。
//
