...
import { KIND_LABELS, renderExamTypeOptions } from "./physioItemOptions";
...
interface Props {
   ...
   */
  excludeCodes?: string[];
  onSelect: (item: PhysioItem) => void;
  onClose: () => void;
}

// 生理検査オーダー項目を検査種別・名称で探して1件選ぶ。セット構成の追加と
// オーダーレイアウトのマス配置で同じものを使う。
export function PhysioItemSearchModal({
  title = "生理検査オーダー項目を選択",
  excludeCodes = [],
  onSelect,
  onClose,
