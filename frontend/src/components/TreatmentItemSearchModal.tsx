...
import { useTreatmentItemSearch, type TreatmentItemFilters } from "../api/masterQueries";
import { ErrorBanner } from "./ErrorBanner";
import { Modal } from "./Modal";
import { KIND_LABELS } from "./treatmentItemOptions";
...
// 処置オーダー項目を名称で探して1件選ぶ。セット構成の追加と
// オーダーレイアウトのマス配置で同じものを使う。
export function TreatmentItemSearchModal({
  title = "処置オーダー項目を選択",
  excludeCodes = [],
  onSelect,
  onClose,
