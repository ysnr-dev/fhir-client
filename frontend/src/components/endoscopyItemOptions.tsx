import type { EndoscopyExamType } from "../api/masterClient";

// 内視鏡オーダー項目の画面表示で共通に使う選択肢・ラベル。項目マスタの編集画面と
...
export function renderExamTypeOptions(examTypes: EndoscopyExamType[]) {
